...
const submitButtons = document.querySelectorAll('.quiz button#button-addon2');
...
function submitAnswer() {
  ...
  if (!hasSelected) {
    ...
    return; // Prevent further processing if no checkbox is selected
  }
...
submitButtons.forEach(button => button.addEventListener('click', submitAnswer));
